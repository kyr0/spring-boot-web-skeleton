...
@AllArgsConstructor
@Slf4j
@Table(name = "skeleton_clientdata")
public class ClientDataEntity extends SpringSecurityAuditorAware implements Serializable {
    ...
    // example for client data extensibility
    @Size(max = 250)
